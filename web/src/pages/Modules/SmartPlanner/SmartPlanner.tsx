...
type Task = { id: string; title: string; description: string; areaId: string; assignedTo: string; status: Status; priority: 'baja' | 'media' | 'alta'; startDate: string; dueDate: string };
...
const emptyTask = (): NewTask => ({ title: '', description: '', areaId: '', assignedTo: '', priority: 'media', startDate: new Date().toISOString().slice(0, 10), dueDate: new Date().toISOString().slice(0, 10) });
