                    ...
                    <Modal.Body className="modal-body">
                        <div className="d-flex mb-4">
                            ...
                            <div className="flex-shrink-0">
                                <Link to="#" className="avtar avtar-s btn-link-danger btn-pc-default" onClick={() => setShowLoginModal(false)}>
                ...
                <div className="modal-content card mb-0 user-card">
                    <Modal.Body>
                        <div className="d-flex mb-4">
                            ...
                            <div className="flex-shrink-0">
                                <Link to="#" className="avtar avtar-s btn-link-danger btn-pc-default" onClick={() => setShowRegisterModal(false)}>
                                    <i className="ti ti-x f-20"></i>
                                </Link>
                            </div>
                        </div>
