                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <img src={widget} alt="img" className="img-fluid wow animate__fadeInUp" data-wow-delay="0.2s" />
                        </div>
                        <div className="col-md-6">
                                ...
                                <Tab.Content id="pills-tabContent">
                                    <Tab.Pane eventKey="pills-home" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        ...
                                        <div className="wow animate__fadeInUp" data-wow-delay="0.8s">
                                            <Link to="../dashboard" className="btn btn-primary me-2">Explore</Link>
                                            <Link to="../dashboard" className="btn btn-outline-secondary">Live preview</Link>
                                        </div>
                                    </Tab.Pane>
