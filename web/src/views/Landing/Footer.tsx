                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-4 wow animate__fadeInUp" data-wow-delay="0.2s">
                                <img src={logoDark} alt="image" className="img-fluid mb-3" />
                                ...
                                <div className="row">
                                    <div className="col-sm-4 my-3 my-sm-0 wow animate__fadeInUp" data-wow-delay="0.6s">
                                        ...
                                        <ul className="list-unstyled footer-link">
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">About</Link></li>
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">Blog</Link></li>
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">Team</Link></li>
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">Free Version</Link></li>
                                        </ul>
                                    </div>
                                    <div className="col-sm-4 my-3 my-sm-0 wow animate__fadeInUp" data-wow-delay="0.8s">
                                        <h5 className="mb-4">Help & Support</h5>
                                        <ul className="list-unstyled footer-link">
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">Documentation</Link></li>
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">Contact us</Link></li>
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">Support</Link></li>
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">RoadMap</Link></li>
                                        </ul>
                                    </div>
                                    <div className="col-sm-4 my-3 my-sm-0 wow animate__fadeInUp" data-wow-delay="1s">
                                        <h5 className="mb-4">Useful Resources</h5>
                                        <ul className="list-unstyled footer-link">
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">Terms & Condition</Link></li>
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">Privacy Policy</Link></li>
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">Licencse</Link></li>
                                            <li><Link style={{ textDecoration: "none" }} to="#" target="_blank">FAQ</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
