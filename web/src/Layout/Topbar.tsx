...
export default function TopBar({ changeThemeMode, toogleSidebarHide, toogleMobileSidebarHide }: HeaderProps) {
  const dispatch = useDispatch<any>(); const { user, logout } = useAuth(); const { role } = useActiveCampaign(); const navigate = useNavigate(); const [search, setSearch] = useState('');
