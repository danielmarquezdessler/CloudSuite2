...
export default function AppLauncher() {
  ...
  return <Dropdown as="li" className="pc-h-item cloudsuite-launcher">
    ...
    <Dropdown.Menu className="dropdown-menu-end pc-h-dropdown p-2 cloudsuite-launcher-menu">
      ...
      <style>{`.cloudsuite-launcher-menu{width:min(560px,calc(100vw - 24px));background:var(--bs-body-bg);border-color:rgba(var(--bs-primary-rgb),.18)}.cloudsuite-launcher__header{padding:.25rem .5rem .75rem}.cloudsuite-launcher-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.cloudsuite-launcher-card{min-width:0}.cloudsuite-launcher-card .cd-card__body{height:100%;padding:0}.cloudsuite-launcher-item{position:relative;width:100%;height:100%;min-height:126px;border:0;border-radius:inherit;background:transparent;color:var(--bs-body-color);display:block;padding:1rem;text-align:left;text-decoration:none;transition:transform .15s ease,box-shadow .15s ease,background .15s ease}.cloudsuite-launcher-item:hover:not(:disabled){background:var(--bs-tertiary-bg);box-shadow:0 .35rem .8rem rgba(var(--bs-primary-rgb),.12);transform:translateY(-2px);color:var(--bs-body-color)}.cloudsuite-launcher-item:focus-visible{outline:2px solid var(--bs-primary);outline-offset:2px}.cloudsuite-launcher-item__content{height:100%;align-items:flex-start}.cloudsuite-launcher-icon{font-size:1.65rem;line-height:1}.cloudsuite-launcher-item__copy{min-width:0}.cloudsuite-launcher-item__title{font-size:.86rem;font-weight:700;line-height:1.2}.cloudsuite-launcher-item__title i{font-size:.78rem;color:var(--bs-gray-600)}.cloudsuite-launcher-item__copy small{font-size:.7rem;line-height:1.35}.cloudsuite-launcher-item .badge{position:absolute;top:.5rem;right:.5rem;font-size:.55rem}.cloudsuite-launcher-card.is-disabled{opacity:.62}.cloudsuite-launcher-card.is-disabled .cloudsuite-launcher-item{cursor:not-allowed}@media(max-width:575.98px){.cloudsuite-launcher-grid{grid-template-columns:1fr}.cloudsuite-launcher-item{min-height:104px}}`}</style>
    </Dropdown.Menu>
  </Dropdown>;
}
