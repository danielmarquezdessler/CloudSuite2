...
campaignRouter.get('/organizations/:orgId/campaign-templates', requireAuth, controller.getCampaignTemplates);
campaignRouter.post('/organizations/:orgId/campaign-templates', requireAuth, controller.postCampaignTemplate);
campaignRouter.delete('/organizations/:orgId/campaign-templates/:templateId', requireAuth, controller.removeCampaignTemplate);
...
campaignRouter.get('/organizations/:orgId/campaigns/:campId/timeline', requireAuth, controller.getCampaignTimeline);
